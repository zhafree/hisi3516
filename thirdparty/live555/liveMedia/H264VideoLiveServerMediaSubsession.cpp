...
FramedSource* H264VideoLiveServerMediaSubsession::createNewStreamSource(unsigned clientSessionId, unsigned& estBitrate) {
  ...
  H264VideoLiveSource::DeviceParameters sourceParams;
  sourceParams.sessionId = clientSessionId;
  sourceParams.estBitrate = estBitrate;
  sourceParams.channelId = 0;

  // Create the video source:
  H264VideoLiveSource* deviceSource = H264VideoLiveSource::createNew(envir(), sourceParams);
